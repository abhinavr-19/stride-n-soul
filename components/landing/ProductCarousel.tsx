...
export default function ProductCarousel() {
    ...
    return (
        <section className="py-32 bg-charcoal overflow-hidden relative" id="collections">
...
function ProductCard({ product }: { product: typeof products[0] }) {
    ...
    return (
        <motion.div
            className="group relative min-w-[280px] md:min-w-[400px] aspect-3/4 bg-neutral-900 overflow-hidden shrink-0 border border-white/5 hover:border-lime/30 transition-all duration-300"
        >
            <div className="absolute inset-0 bg-transparent group-hover:bg-lime/5 transition-colors duration-500" />
            ...
            <div className="absolute bottom-0 left-0 right-0 p-6 translate-y-4 group-hover:translate-y-0 transition-transform duration-300">
                <div className="flex justify-between items-end">
                    <div>
                        <p className="text-xs text-vapor/60 mb-1 font-bold tracking-widest uppercase group-hover:text-lime transition-colors">
                            {product.category}
                        </p>
                        <h3 className="text-xl md:text-2xl font-display font-bold text-vapor uppercase leading-none group-hover:text-white transition-colors wrap-break-word">
                            {product.name}
                        </h3>
                        <p className="text-lg font-mono text-lime font-bold mt-2 transition-colors">
                            ${product.price}
                        </p>
                    </div>
                    ...
                    <button
                        ...
                        className="w-12 h-12 bg-vapor text-charcoal rounded-full flex items-center justify-center opacity-0 group-hover:opacity-100 translate-y-4 group-hover:translate-y-0 transition-all duration-300 hover:bg-lime hover:text-charcoal"
                    >
                        <Plus />
                    </button>
                </div>
